    ...
    def _strategy_snapshot(
        ...
        return {
            ...
            "config": {
                ...
                "inventory_soft_limit_btc": self._settings.inventory_soft_limit_btc,
            ...
            "research_presets": [
                {
                    ...
                    "inventory_soft_limit_btc": max(
                        self._settings.inventory_soft_limit_btc - 0.1,
                        self._settings.order_size_btc,
                    ),
                ...
                },
                {
                    ...
                    "inventory_soft_limit_btc": self._settings.inventory_soft_limit_btc + 0.25,
